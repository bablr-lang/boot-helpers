...
const { isArray } = Array;
const { ReferenceTag, GapTag, LiteralTag, Trivia, Escape } = require('./symbols.js');
...
const gap = () => freezeSeal({ type: GapTag, value: undefined });

const lit = (str) => freezeSeal({ type: LiteralTag, value: stripArray(str) });
